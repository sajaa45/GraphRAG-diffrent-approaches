#!/bin/bash
# Quick test script for multi-relation extraction
...
# Test 3: Extract multiple relations
echo ""
echo "=========================================="
echo "Test 3: Extract Multiple Relations"
echo "=========================================="
RELATIONS="CEO COMPETES_WITH HAS_METRIC" docker-compose up multi-relation-kg
